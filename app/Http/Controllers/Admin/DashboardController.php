...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $data["penanggungjawab"] = PenanggungJawabModel::orderBy('penanggungjawab_id', 'DESC')->count();
        $data["bm"] = BarangmasukModel::leftJoin('tbl_barang', 'tbl_barang.barang_kode', '=', 'tbl_barangmasuk.barang_kode')->leftJoin('tbl_penanggungjawab', 'tbl_penanggungjawab.penanggungjawab_id', '=', 'tbl_barangmasuk.penanggungjawab_id')->orderBy('bm_id', 'DESC')->count();
