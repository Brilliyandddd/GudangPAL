    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-body text-center p-4 pb-5">
                ...
                <h3 class="mb-5">Yakin hapus <span id="vbdp"></span> ?</h3>
                <input type="hidden" name="idbdp" id="idbdp">
...
@section('formHapusJS')
    <script>
        function submitFormH() {
            setLoadingH(true);
            const id = $("input[name='idbdp']").val();
            $.ajax({
                type: 'POST',
                url: "{{ url('admin/barang-dipinjam/proses_hapus') }}/" + id,
