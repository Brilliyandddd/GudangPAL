        ...
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="penanggungjawab" class="form-label">Nama Penanggung Jawab <span
                            class="text-danger">*</span></label>
                    <input type="text" name="penanggungjawab" class="form-control" placeholder="">
                </div>
            </div>
    ...
    <script>
        function checkForm() {
            ...
            if (penanggungjawab == "") {
                ...
                $("input[name='penanggungjawab']").addClass('is-invalid');
                setLoading(false);
                return false;
            } else {
                submitForm();
        ...
        function submitForm() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('penanggungjawab.store') }}",
        ...
        function resetValid() {
            $("input[name='penanggungjawab']").removeClass('is-invalid');
        };

        function reset() {
            resetValid();
            $("input[name='penanggungjawab']").val('');
            setLoading(false);
        }
