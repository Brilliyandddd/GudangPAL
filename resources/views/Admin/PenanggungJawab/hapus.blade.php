    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-body text-center p-4 pb-5">
                ...
                <h3 class="mb-5">Yakin hapus <span id="vpenanggungjawab"></span> ?</h3>
...
@section('formHapusJS')
    <script>
        function submitFormH() {
            setLoadingH(true);
            const id = $("input[name='idpenanggungjawab']").val();

            $.ajax({
                type: 'POST',
                url: "{{ url('admin/penanggungjawab/proses_hapus') }}/" + id,
        ...
        function resetH() {
            $("input[name='idpenanggungjawab']").val('');
            setLoadingH(false);
        }
